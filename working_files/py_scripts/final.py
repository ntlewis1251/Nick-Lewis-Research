...
def maps():
    """
    Uses downloaded DEM object to export a TRI (Terrain Ruggedness Index, similar to local relief) map, a slope map, and knickpoints overlaying slope map (hued by Delta KSN) 
    """
